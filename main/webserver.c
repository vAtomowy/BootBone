...
static const char* form_html = 
   ...
   "    .container { max-width: 400px; margin: 80px auto 20px auto; text-align: center; }"
   ...
   "    footer { margin-top: 50px; padding: 10px 20px; font-size: 12px; font-weight: bold;"
   "             display: flex; justify-content: space-between; }"
   "  </style>"
   "</head>"
   "<body>"
   "  <div class='container'>"
   "    <img src='logo.png' alt='Logo' style='max-width: 25vw; height: auto; margin: 0 auto; display: block; margin-bottom: 40px;'>"
